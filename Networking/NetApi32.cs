...
//wrapper for the widows networking API
...
namespace Networking
{
    public class NetApi32
    {
        ...
        #region Nested type: SERVER_INFO_101

        [StructLayout(LayoutKind.Sequential)]
        public struct SERVER_INFO_101
        {
            [MarshalAs(UnmanagedType.U4)] public UInt32 sv101_platform_id;
            [MarshalAs(UnmanagedType.LPWStr)] public string sv101_name;

            [MarshalAs(UnmanagedType.U4)] public UInt32 sv101_version_major;
            [MarshalAs(UnmanagedType.U4)] public UInt32 sv101_version_minor;
            [MarshalAs(UnmanagedType.U4)] public UInt32 sv101_type;
